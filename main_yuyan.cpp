...
public:
    ...
    bool operator()(const T *_q, const T *_t, T *residuals) const
    {
        ...
        const T W = T(5188); // 画幅宽
        const T H = T(2594); // 画幅高
...
int main()
{
    ...
    // string lidar_path = "/Users/losehu/Documents/归档/Pano_Video/calib/sign/lidar_1120.txt"; // 雷达标注点
    // string lidar_path = "/Users/losehu/Library/Containers/com.tencent.xinWeChat/Data/Documents/xwechat_files/wxid_y3fi4f9tcu0322_11eb/msg/file/2025-11/913_/lidar_OUT913.txt";
    string lidar_path="/Users/losehu/Library/Containers/com.tencent.xinWeChat/Data/Documents/xwechat_files/wxid_y3fi4f9tcu0322_11eb/msg/file/2025-11/923_2/lidar_OUT923.txt";
    // string photo_path = "/Users/losehu/Downloads/911_/cam_point.txt";        // 全景标注点
    // string photo_path = "/Users/losehu/Library/Containers/com.tencent.xinWeChat/Data/Documents/xwechat_files/wxid_y3fi4f9tcu0322_11eb/msg/file/2025-11/913_/cam_point913.txt";
    string photo_path="/Users/losehu/Library/Containers/com.tencent.xinWeChat/Data/Documents/xwechat_files/wxid_y3fi4f9tcu0322_11eb/msg/file/2025-11/923_2/cam_point923.txt";
    string extrinsic_path = "./sign/extrinsic_923.txt";    // 输出的外参路径
    // string vaild_path ="/Users/losehu/Library/Containers/com.tencent.xinWeChat/Data/Documents/xwechat_files/wxid_y3fi4f9tcu0322_11eb/msg/file/2025-11/911_ 2/image";
    string vaild_path ="/Users/losehu/Library/Containers/com.tencent.xinWeChat/Data/Documents/xwechat_files/wxid_y3fi4f9tcu0322_11eb/msg/file/2025-11/923_2/image";
    ...
    for (size_t i = 0; i < all_rotations.size(); ++i)
    {
            ...
            if (error[0] + error[1] < error_shit)
        {
            ...
            // 记录当前最优误差，稍后展示
            best_error[0] = error[0];
            best_error[1] = error[1];
        }
    }

    // 使用最优外参展示最终结果（带可视化）
    float display_error[2] = {0.0f, 0.0f};
    cout << "最好的重投影误差是: " << error_shit << " (recomputed: " << display_error[0] + display_error[1] << ")" << endl;
    getUVError_yuyan(extrinsic_path, lidar_path, photo_path, display_error, error_threshold, vaild_path, 1);
}
